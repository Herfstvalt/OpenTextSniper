...
class ClipboardWindowController: NSObject, NSTableViewDataSource, NSTableViewDelegate, NSTextFieldDelegate {
    ...
    private func setup() {
        ...
        NotificationCenter.default.addObserver(
            forName: ClipboardHistory.didChangeNotification,
    ...
    func tableView(_ tableView: NSTableView, viewFor tableColumn: NSTableColumn?, row: Int) -> NSView? {
        ...
        // Timestamp + char count on the right
        let meta = "\(entry.text.count) chars · \(entry.relativeTime)"
        ...
        NSLayoutConstraint.activate([
            ...
            metaField.leadingAnchor.constraint(equalTo: cell.leadingAnchor, constant: 16),
            metaField.trailingAnchor.constraint(equalTo: cell.trailingAnchor, constant: -16),
            metaField.bottomAnchor.constraint(equalTo: cell.bottomAnchor, constant: -4),
        ])
